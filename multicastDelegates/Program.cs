...
namespace assignment8ex1
{
    class Program
    {
        ...
        {
            songDelegate newDelegate = new songDelegate(HereComesTheSun.chorus);
            newDelegate += HereComesTheSun.verse1;
            newDelegate += HereComesTheSun.chorus;
            newDelegate += HereComesTheSun.verse2;
            newDelegate += HereComesTheSun.chorus2;
            newDelegate += HereComesTheSun.verse3;
            newDelegate += HereComesTheSun.chorus;
            newDelegate += HereComesTheSun.chorus;
            newDelegate += HereComesTheSun.end;
            newDelegate();
        }
    }
}